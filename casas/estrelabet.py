...
caminho_html = 'file://' + os.path.expanduser('~/Downloads/Casa de Aposta EstrelaBet_ Aposta Esportiva e Cassino OnLine!.html')
...
# dftime = df.loc[
#     df.aa_classList.str.contains('rcl-ParticipantFixtureDetails_BookCloses', regex=True, na=False)].aa_innerText
#
# num_jogos = dftime.shape[0]
#
# jogos = df.loc[
#     df.aa_classList.str.contains('rcl-ParticipantFixtureDetails_TeamNames', regex=True, na=False)].aa_innerText
# time1 = []
# time2 = []
# for jogo in jogos:
