...
# campeonato_nome = 'brasileiraoc'
    ...
    try:
        ...
        return "Erro: Campeonato não encontrado na base de dados da SeguroBet."
    ...
    with open(pasta_casas + 'casas-html/segurobet.html', 'w', encoding='utf-8') as file:
        file.write(page_source)
    driver_to_save.quit()

    driver = Driver(uc=True)
    current_dir = os.path.dirname(os.path.abspath(__file__))
    caminho_html = os.path.join(current_dir, 'casas-html/segurobet.html')
